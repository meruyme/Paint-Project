...
/**
 * JDialog que será usado para o usuário selecionar as informações necessárias para desenhar um retângulo na tela. 
 * @author Mellany Linhares
 *
 */
public class CadastrarRetangulo extends JDialog {
	 ...
	 */
    public CadastrarRetangulo(int x, int y, Formas formas, PaintJPanel panel, DefaultListModel modelo) {
        
        setModalityType(DEFAULT_MODALITY_TYPE);
        setTitle("Desenhar retângulo");
        ...
        btnSelecionarCor.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent arg0) {
                corSelecionada = JColorChooser.showDialog(CadastrarRetangulo.this, "Selecione uma cor", corSelecionada);
        ...
        {
            JLabel lblTipoDeRetngulo = new JLabel("Tipo de ret\u00E2ngulo:");
            ...
            getContentPane().add(buttonPane, BorderLayout.SOUTH);
            {
                ...
                btnDesenhar.addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        ...
                        Retangulo rect = new Retangulo(x, y, corSelecionada, preenchido, txtBase.getText(), txtAltura.getText()); 
                        ...
                        if(contrl == true){ 
                            if(formas.addFormas(rect,modelo)) { 
                            	panel.repaint();
                                dispose();
                            }
                        }
